...
{
    public partial class Realme_PHONE : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into REALME values(@phone_id,@phone_model,@phone_price,@phone_discount,@total_price,@Phone_picture)";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd1 = new SqlCommand("select PHONE_ID,PHONE_MODEL,PHONE_PRICE,PHONE_DISCOUNT,TOTAL_PRICE,PHONE_PICTURE from REALME where PHONE_MODEL = @phone_model", con);
